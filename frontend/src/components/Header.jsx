      ...
      <div className='flex flex-col md:flex-row flex-wrap bg-gradient-to-b from-[#009493] to-[#1e293b] rounded-lg px-6 md:px-10 lg:px-20'>
        ...
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
          ...
          <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
            ...
            <button onClick={() => { navigate('/'); scrollTo(0, 620) }} className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-[#595959] text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300'>Book Appointment <img className='w-3' src={assets.arrow_icon} alt="" /></button>
        ...
        <div className="flex flex-col gap-10 max-w-3xl mx-auto"> */}
          ...
          {/* <div className="bg-white/5 border border-white/10 rounded-xl p-8 shadow-md hover:shadow-lg transition-all duration-300">
            ...
            <p className="text-sm md:text-base text-gray-300">
              ...
              <button onClick={() => navigate('/LocationMap')} className="inline-block mt-6 bg-white text-[#1f2937] font-medium px-6 py-3 rounded-full hover:scale-105 transition duration-300">Search Hospitals</button>
